...
Conv2D::Conv2D(const string& name,
...
#ifdef _OPENMP
#pragma omp parallel for collapse(2) private(target_top, target_left, target_x, target_y, within_range_counter, weighted_pixel)
#endif
